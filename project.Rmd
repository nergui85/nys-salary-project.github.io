...
New York City (NYC) is recognized as having the largest regional economy in the United States (5).If an individual country, it would be ranked as the 10th largest global economy (6). Our motivation for this project is to use the skills that we have learned in Data Science I and apply them to answer imperative questions about NYC, such as which NYC borough yields the highest and lowest average total pay. This data would be determined by combining salary, overtime, and other pay from NYC’s 2022 municipal employees ‘payroll budget. 
 
Cities around the country suffered  economic losses from the COVID-19 pandemic and the prospects of a recession began stirring fears of an uncertain economy. City managers are more cautious about  fiscal spending compared to previous years in response to COVID -19. As a result, many states and municipalities have made cuts, frozen spending and hiring, laid off workers and  have reduced budgets. Our project will detail how the City's budget is being spent on by conducting statistical analysis to evaluate the significant differences in base salary among New York State. This information should prove useful to the general public as well as for recent graduates looking for opportunities in NYC municipal employment.
 

## Related work

As the economy recovers in 2022, challenges are found in various sectors. (1). According to Omeyr, “Governments are being super cautious and very conservative when it comes to budgeting for the near future and for fiscal year 2022 and 2023”. The New York State Budget will total $220.5 billion in 2022-23. The Budget was adopted following two years of extraordinary volatility in State finances that began with the unprecedented economic disruptions caused by the COVID-19 pandemic and the prospect of steep revenue shortfalls. Due to Economic performance suppression, unanticipated revenues were generated and spending as increased greatly, both for temporary investments for pandemic-related needs and expanded or new commitments to existing programs (3). Allocating a budget on the payroll is one of the state's duties. This data was obtained from the NYC Open data records. This dataset is provided by the Office of Payroll Administration (OPA).  
...
1. How many municipal employees in the New York State counties were active, have stopped working, or were on leave?
2. Which New York  State counties had the highest mean base salary?
...
7. What percentage of all municipal employees are active, have ceased working, or are on leave?
...
9. What were the top 10 job titles throughout the New York State counties?
10. What were the top 5 job titles in Kings county, Albany county, New York county, Richmond county, and Queens county?
...
Figure 3 shows the base salary for municipal employees that are paid annually in New York State by county. According to this Figure 3, Orange, Greene, Putnam and Bronx have the lowest median base salary around 60,000 dollars for its municipal employees, whereas Albany has the highest median base salary with around 85,000 dollars followed by New York county. Compared to the mean base salary, median base salary in New York States was significantly higher after Albany, which was similar to our hypothesis that New York County would have a higher income level.
...
Figure 5 illustrates hourly median base salary for municipal employees of New York State by county. The hourly median salary ranged between 0 to 95 dollars. Figure  illustrates that New York County has the lowest hourly median base salary with 0 dollars while Nassau ranked highest around 65 to 70 dollars followed by Dutchess and Sullivan, Schoharie respectivly. It shows that highly populated counties have lower hourly median base salary compared to less populated counties. 
...
Since we are based in New York City, NYC, we decided to look at the top 5 job titles for each of the counties for the 5 boroughs in NYC and compare that with top 5 job titles with the top 5 job titles in Albany county because Albany has the highest mean base salary.  We chose Richmond county, Bronx county, Kings county, Queens county, and New York county as they all represent New York City boroughs which is one of the largest financial epicenters.  These counties were also chosen because when looking at the bar graph for the number of job titles held by employees, you saw that the ones that had the most number of job titles were the counties that were selected.  We conducted a scatterplot to see which county has a high number of specific job titles.  Looking at the plot, you can see that in New York county, the number of teachers per session was 113,882 meaning that New York County has the highest number of teachers per session among the six counties.  Queens county had the highest number of correction officers, 7,708.  For Bronx county, their highest job title was a police officer, 3,807. However, it was Kings county who had the most police officers as they had 5,815.  Albany county had the most number of assistant legislative representatives which was 4. 
...
Median total overtime pay for municipal employees in New York State by its counties in 2022 is displayed in the box plot. Figure 11 illustrated that New York county was among the lowest median counties for total overtime along with Albany, Nassau, New York and Orange which was close to 0 dollars, while Greene ranked highest median for total overtime pay with around 7000 dollars. This pattern is similar to that of New York County for median for total other pay where it placed the lowest in Figure. We assumed that since New York County has a big market with more opportunities. This finding supported our hypothesis and median for prorated annual base salary Figure where New York County ranked highest. In addition, it was noticeable that New York county has the greatest number of outliers, which may be due to the large population within this county whereas Greene, Orange and Dutchess counties did have outliers.
...
We also performed a bar graph to show the distribution of leave status. In 2022, there were a total of 594,234 municipal employees across New York state counties.  The graph shows that 481,781 municipal employees had a leave status of active and 102,360 employees had a leave status of ceased.  The remaining number of municipal employees, 10,093, were on leave. 
...
We constructed a pie chart which shows the percentages of leave status for all municipal employees in 2022. We assumed that the majority of the municipal employees across all New York state counties would have a leave status of active. 81.1 % of the municipal employees were actively working which was to be expected.  17.2 % of employees have stopped working at their municipal jobs and 1.7 municipal employees were on leave. 


Work Cited: 
1. https://en.wikipedia.org/wiki/Economy_of_New_York_City#:~:text=The%20economy%20of%20New%20York,the%20world's%20premier%20financial%20center.
...
In our exploratory analysis, we looked at leave status, base salary, overtime pay, job titles, total other pay, and base salary by pay basis across New York State counties in 2022.

Prior to computing the percentages and numbers of leave status employees for all 16 counties, we predicted that most of the municipal employees had an active leave status at the end of the fiscal year, which was true as the majority of the 594,234 employees were actively working.  The remaining number of employees were either on leave or stopped working. 

When looking at the mean salary of municipal employees in New State York counties, we found it interesting that Albany had the highest mean base salary. We saw that there was a notable difference in the average base salary between New York County and Albany county. We assumed that the average base salary in New York county would be fairly high due to it being known as a financial hub in New York State and throughout the United States.  

Since Albany had the highest mean base salary, we decided to look at the job titles across all 16 counties in New York. We also expected that New York county would have the most number of job titles due its large population. When looking at the number of job titles in New York state counties, New York county did indeed have the highest number of job titles.  Queens county had the second highest number, Kings county had the third highest number, and Bronx county had the fourth highest number of job titles. We found it interesting that Albany county had the third lowest number of job titles meaning that the variability of jobs is low.

We also looked at the top 5 job titles across Bronx, Kings, Queens, New York, Richmond, and Albany counties.  The most prominent job titles were Correction Officer, Assistant Legislative Representative, Teacher per session, and Police Officer.  It was interesting that Albany had the fewest number of job titles, which was 6, and the highest mean base salary.  The job title with the highest number of people in Albany county is the Assistant Legislative Representative.  Four people had this job title.  The other job titles for Albany were Watershed Maintainer, Assistant Director of Intergovernmental Relations for Albany, Special Assistant, Stationary Engineer and Supervisor.  Overall, this information illustrates that certain job titles that pay higher base salaries can skew the data even though there are very few people with these job titles.  

We also looked at the total other pay for municipal employees across all New York State counties in 2022 and found that New York county had the lowest median total other pay, while Schoharie county had the highest, which was approximately more than 5,000 dollars for municipal employees. This was a result that we did not expect and we believed that New York county would also have the highest median total other pay. It is important to acknowledge that New York county had numerous outliers which could have been possible due to its large population and the large diversity of job titles. Other counties that had many outliers were Queens, Bronx, and Kings.   

In addition to looking at the mean base salary, we also chose to look at the median base salary by annual, daily, hourly, and prorated annual pay basis.  Albany had the highest annual median base salary with New York county coming in second. For the daily median base salary, Albany, Dutchess, and Greene county had among the highest.  Nassau county had the highest hourly median base salary.  For the median prorated annual base salary, Ulster county had the highest followed by New York county.  

We also determined which county had the highest median total overtime pay for municipal employees in New York State counties in 2022.  It was found that New York had the lowest median total overtime pay while Greene county had the highest.  

In our statistical analysis, specifically the ANOVA test, we claimed that there is a significant  difference between the means of base salary for the New York State counties.  This hypothesis was proven to be true as the p value was zero, which supported the rejection of the null hypothesis that there was no difference in the mean base salary among the counties. We also predicted that there would be significant differences in the mean base salary between the counties. With the Tukey test, we saw that there were many significant differences in the mean base salary when comparing the counties among one another. Some significant differences were: New York and Albany, Kings and Bronx, New York and Bronx, Richmond and Kings, and Ulster and Kings.  Ultimately, we saw that most of the significant differences were between NYC’s 5 boroughs and Albany as their p values were less than 0.05. 
...
5. https://en.wikipedia.org/wiki/Economy_of_New_York_City
6. https://en.wikipedia.org/wiki/Economy_of_New_York_(state). 
